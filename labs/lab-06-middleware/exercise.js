...
//
// Pour intercepter la fin de la reponse, utiliser res.on('finish', ...):
//   res.on('finish', () => {
//     const duration = performance.now() - start;
//     // Note: on ne peut plus modifier les headers apres finish
//   });
//
// ASTUCE : Utiliser res.setHeader() AVANT que la reponse soit envoyee.
// Une approche : surcharger res.end pour ajouter le header juste avant l'envoi.
//
// Approche simplifiee : ajouter le header dans un callback onHeaders-like.
