...
>
> **Temps estime** : ~200-260h (6-8 mois a 8-10h/semaine)
>
...
### Phase 5 -- Production (modules 18-26) ~60-80h
...
- _Node.js Design Patterns_ (Casciaro, Mammino) -- le livre de reference Node.js
- _NestJS in Action_ -- patterns avances et architecture
